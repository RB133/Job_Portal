//dummy code written by chatgpt 
//we will change it using the source code file once we run backend
...
const RecruiterLogin = () => {
    ...
    const onSubmitHandler = (e) => {
        ...
        const dummyCompany = {
            name: name || 'Demo Company',
            email: email || 'demo@example.com',
            logo: assets.upload_area // fallback static image
        }

        setCompanyData(dummyCompany)
        setCompanyToken('dummy-token-123') // just for simulation
